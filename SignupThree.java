...
public class SignupThree  extends JFrame implements ActionListener  {
	//Instance variable
	JLabel l1,lblAccountType,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12;
	...
	public SignupThree(String formno) {
		...
		lblAccountType.setFont(new Font("Ralway" ,Font.BOLD,18 ));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		long num1=(random.nextLong()%90000000L)+505090600000L;
